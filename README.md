...
Я развиваю проект **«Backend без пафоса»**: open source, backend-контент, Мемасы.
...
- [t.me/backendbezpafosa](https://t.me/backendbezpafosa) - развлекательный телеграм-канал

Если контент оказался полезными, можно поддержать на [Boosty](https://boosty.to/backendbezpafosa)
